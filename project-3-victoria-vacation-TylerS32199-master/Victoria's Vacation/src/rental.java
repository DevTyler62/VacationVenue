...
public void setTypeOfRental(String typeOfRentalEquiment) {
	...
	System.out.println("Welcome to Victoria's Vacation Venue where we offer rentals of vacation equiment.");
	System.out.println("We offer for rental boats, chairs, and umbrellas.");
	System.out.println("What equiment would you like to rent today? ");
